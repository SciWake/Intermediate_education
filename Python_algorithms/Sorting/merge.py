...
def merge_2(left_list, right_list):
    sorted_list = []
...
def merge_sort_2(array):
    ...
    return merge_2(left_list, right_list)
...
def merge_sort_3(array):
    ...
    mid = len(array) // 2
    left_list = merge_sort_3(array[:mid])
    right_list = merge_sort_3(array[mid:])

    return merge_3(left_list, right_list)
